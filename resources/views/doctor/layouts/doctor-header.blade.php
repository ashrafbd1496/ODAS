    ...
    <div class="header">
        ...
        <ul class="nav user-menu">
            ...
            <li class="nav-item dropdown has-arrow">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                    <span class="user-img"><img class="rounded-circle" src="{{ asset('admin/assets/img/profiles/ashraf.jpg') }}" width="31" alt="{{ Auth::guard('doctor')->user()->name }}">
                    </span>
                </a>
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="{{route('doctor.profile',Auth::guard('doctor')->id())}}">
                        My Profile</a>
